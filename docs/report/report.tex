...
The application must be able to handle concurrent request to the database remaining 
consistent between every operation. A real-time system (but not hard real-time) of response is also required 
for this type of application in order to ensure a comfortable use.
